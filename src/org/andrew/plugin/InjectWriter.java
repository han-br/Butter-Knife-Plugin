...
public class InjectWriter implements Runnable {
    ...
    protected boolean mUseR2;

    public InjectWriter(PsiFile file, PsiClass clazz, String command, ArrayList<Element> elements, String layoutFileName, String fieldNamePrefix, boolean createHolder, boolean splitOnclickMethods, boolean useR2) {
        mFile = file;
    ...
    protected void generateAdapter(@NotNull IButterKnife butterKnife) {
        ...
        for (Element element : mElements) {
            ...
            if (element.isAndroidNS) {
                rPrefix = "android.R"+(mUseR2?"2":"")+".id.";
            } else {
                rPrefix = "R"+(mUseR2?"2":"")+".id.";
            }
