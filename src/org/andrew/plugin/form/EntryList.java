...
public class EntryList extends JPanel {
    ...
    protected JCheckBox useR2Check;
    ...
    protected void addButtons() {
		...
		*/
        ...
        mHolderLabel.setText("创建ViewHolder");
...
//        add(splitOnclickMethodsPanel, BorderLayout.PAGE_END);
        ...
        useR2Check = new JCheckBox();
        useR2Check.setPreferredSize(new Dimension(32, 26));
        useR2Check.setSelected(false);

        final JLabel useR2TypeTitle = new JLabel();
        useR2TypeTitle.setText("使用R2");

        final JPanel useR2Type = new JPanel();
        useR2Type.setLayout(new BoxLayout(useR2Type, BoxLayout.LINE_AXIS));
        useR2Type.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10));
        useR2Type.add(useR2Check);
        useR2Type.add(useR2TypeTitle);
        useR2Type.add(Box.createHorizontalGlue());
        add(useR2Type, BorderLayout.PAGE_END);
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (valid) {
                if (mConfirmListener != null) {
                    mConfirmListener.onConfirm(mProject, mEditor, mElements, mPrefix, mCreateHolder, false,useR2Check.isSelected());
                }
            }
        }
    }
